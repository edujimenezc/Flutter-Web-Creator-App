...
String textoArchivoHTML="<!DOCTYPE html>\n";
...
textoArchivoHTML=textoArchivoHTML+"""<meta charset="utf-8">
...
textoArchivoHTML=textoArchivoHTML+"""  <style>
...
var url = await ref.getDownloadURL();
    ...
    textoArchivoHTML=textoArchivoHTML+'<body style="background-image: url(${url});background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%;">\n';
  }else{
textoArchivoHTML=textoArchivoHTML+'<body style="background-color:${pageBackground}">\n';
  }
...
textoArchivoHTML=textoArchivoHTML+'<div class="container">\n';
...
if(estilosDivs.containsKey(div)){
  ...
  textoArchivoHTML=textoArchivoHTML+'<div class="container" style="${estiloDivActual}">\n';
...
var url = await ref.getDownloadURL();
textoArchivoHTML=textoArchivoHTML+'<img class="img-responsive" src="${url}" alt="${url}">'+"\n";
...
case 7:
 ...
 textoArchivoHTML=textoArchivoHTML+""" <div style="background-color: #1b1b1b;
    padding-top: 40px;
    padding-bottom: 40px;">
		<div class="container">
			<div class="row">"""+"\n";
...
imgURL= "<img class='img-responsiveFooter' src='${urlBuena}'  />";
}
...
if(url!=""){
  textoArchivoHTML=textoArchivoHTML+'<div class="col-lg-3">${imgURL}<h4 style="${estilos}">${footer["texto"][0]}</h4></div>';
	...
	textoArchivoHTML=textoArchivoHTML+"""</div><!-- --/row ---->
		</div><!-- /container -->
	</div>"""+"\n";
...
if(!url[1].toString().contains("background-color")){

List url2=url[1].toString().split(")");
